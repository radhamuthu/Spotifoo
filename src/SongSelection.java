...
// this method is used to select the song from the display in console and then user may have option to play or go to main menu
    private static void userInputForSongSelection() {
        ...
        try {
            ...
            if (userInput.trim().isEmpty()) throw new InputMismatchException();
            int  userGivenNumber = Integer.parseInt(userInput) ;
    ...
    public static void displaySongNameInConsole(){
        ...
        //To display the song name in console
            for (String i : AssetsFolderReader.songList) {
            System.out.println("["+a + "]. " + i);
            a++;
        }
        System.out.println("[0]. To go back to main menu ");
        System.out.print("Enter your option  :");
        userInputForSongSelection();// allow to select the song from the displayed list in console
